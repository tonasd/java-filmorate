...
(
    ...
    CONSTRAINT REVIEWS_FK FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS(USER_ID) ON delete CASCADE,
    CONSTRAINT REVIEWS_FK_1 FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILMS(FILM_ID) ON delete CASCADE
    );
...
(
    ...
    CONSTRAINT REVIEWS_USERS_FK FOREIGN KEY (REVIEW_ID) REFERENCES PUBLIC.REVIEWS(REVIEW_ID) ON delete CASCADE,
    CONSTRAINT REVIEWS_USERS_FK_1 FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS(USER_ID) ON delete CASCADE
);
